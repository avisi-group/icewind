...
impl Instruction {
    ...
    pub fn cvttss2si(src: Operand, dst: Operand) -> Self {
        Self(Opcode::CVTTSS2SI(src, dst))
    }
    ...
    pub fn encode(
        ...
        match &self.0 {
            ...
            CVTSS2SI(
                ...
                .cvtss2si::<AsmRegister64, AsmRegisterXmm>(
                    dst.try_into().unwrap(),
                    src.try_into().unwrap(),
                )
                .unwrap(),
            ...
            CVTSD2SI(
                ...
                .cvtsd2si::<AsmRegister64, AsmRegisterXmm>(
                    dst.try_into().unwrap(),
                    src.try_into().unwrap(),
                )
                .unwrap(),
            ...
            CVTTSS2SI(
                ...
                .cvttss2si::<AsmRegister32, AsmRegisterXmm>(
                    dst.try_into().unwrap(),
                    src.try_into().unwrap(),
                )
                .unwrap(),
